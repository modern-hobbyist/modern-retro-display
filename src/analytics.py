...
class YouTubeAnalytics:
    def __init__(self) -> None:
        ...
        self._wifi_ssid = "YOUR_WIFI_SSID"
        self._wifi_pass = "YOUR_WIFI_PASSWORD"
        self._yt_key = "YOUR_YOUTUBE_KEY"
        self._yt_channel_id = "UCjgA1ehfjkZ4WMa5Cw9f1LA" # Your channel id, or the channel you want to see stats for
